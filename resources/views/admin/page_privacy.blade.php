...
@section('heading', 'Page Privacy Content')
                ...
                <form action="{{ route('admin_privacy_page_update') }}" method="POST">
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input type="text" class="form-control @error('heading') is-invalid @enderror" name="heading"
                            id="heading" value="{{ old('heading', $page_privacy->heading) }}">
                        @error('heading')
                    ...
                    <div class="form-group mb-1">
                        ...
                        <textarea name="content" id="content"
                            class="form-control h_100 editor @error('content') is-invalid @enderror"
                            rows="5">{{ old('content', $page_privacy->content) }}</textarea>
                        @error('content')
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                    ...
                    <div class="form-group mb-1">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                            id="title" value="{{ old('title', $page_privacy->title) }}">
                        @error('title')
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                    ...
                    <div class="form-group mb-1">
                        ...
                        <textarea name="meta_description" id="meta_description"
                            ...
                            rows="5">{{ old('meta_description', $page_privacy->meta_description) }}</textarea>
