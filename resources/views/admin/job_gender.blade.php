...
@section('button')
<a href="{{ route('admin_job_gender_create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>&nbsp; Add
    Job Location</a>
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pt_10 pb_10 text-center">
                                    <a href="{{ route('admin_job_gender_edit', $item->id) }}"
                                        class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i>
                                        &nbsp; Edit</a> &nbsp;
                                    <a href="{{ route('admin_job_gender_delete', $item->id) }}"
