                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                    ...
                                    <button class="nav-link mb-1" id="v-pills-7-tab" data-bs-toggle="pill"
                            ...
                            <div class="col-lg-9 col-md-6">
                                <div class="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    ...
                                                    <select name="blog_status" id="blog_status" class="form-control">
                                                        <option selected disabled> -- Choose --</option>
                                                        <option value="Show"
                                                            {{ $page_home_data->blog_status == 'Show' ? 'selected' : '' }}>
                                                            Show
                                                        </option>
                                                        <option value="Hide"
                                                            {{ $page_home_data->blog_status == 'Hide' ? 'selected' : '' }}>
                                                            Hide
                                                        </option>
                                                    </select>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-7" role="tabpanel"
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label " for="why_choose_subheading">Meta
                                                Description *
                                            </label>
                                            <textarea name="meta_description" id="meta_description" class="form-control h_100">{{ $page_home_data->meta_description }}</textarea>
                                        </div>
                                    </div>
                                </div>
