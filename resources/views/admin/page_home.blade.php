                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link mb-1" id="v-pills-6-tab" data-bs-toggle="pill"
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea class="form-control" name="text" id="floatingTextarea2"
                                                    style="height: 100px">{{ $page_home_data->text }}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <select name="job_category_status" id="job_category_status"
                                                    ...
                                                    <option value="Show" {{ $page_home_data->job_category_status ==
                                                        'Show' ? 'selected' : '' }}>
                                                        Show
                                                    </option>
                                                    <option value="Hide" {{ $page_home_data->job_category_status ==
                                                        'Hide' ? 'selected' : '' }}>
                                                        Hide
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <select name="why_choose_status" id="why_choose_status"
                                                    class="form-control">
                                                    <option selected disabled> -- Choose --</option>
                                                    <option value="Show" {{ $page_home_data->why_choose_status == 'Show'
                                                        ? 'selected' : '' }}>
                                                        Show
                                                    </option>
                                                    <option value="Hide" {{ $page_home_data->why_choose_status == 'Hide'
                                                        ? 'selected' : '' }}>
                                                        Hide
                                                    </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label class="form-label " for="feature_jobs_heading">Feature Job
                                                    Heading
                                                    *</label>
                                                <input type="text" class="form-control" name="feature_jobs_heading"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control" name="feature_jobs_subheading"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <select name="feature_jobs_status" id="feature_jobs_status"
                                                    class="form-control">
                                                    <option selected disabled> -- Choose --</option>
                                                    <option value="Show" {{ $page_home_data->feature_jobs_status ==
                                                        'Show' ? 'selected' : '' }}>
                                                        Show
                                                    </option>
                                                    <option value="Hide" {{ $page_home_data->feature_jobs_status ==
                                                        'Hide' ? 'selected' : '' }}>
                                                        Hide
                                                    </option>
                                                </select>
                                ...
                                <div class="tab-pane fade" id="v-pills-5" role="tabpanel"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <select name="testimonial_status" id="testimonial_status"
                                                    class="form-control">
                                                    <option selected disabled> -- Choose --</option>
                                                    <option value="Show" {{ $page_home_data->testimonial_status ==
                                                        'Show' ? 'selected' : '' }}>
                                                        Show
                                                    </option>
                                                    <option value="Hide" {{ $page_home_data->testimonial_status ==
                                                        'Hide' ? 'selected' : '' }}>
                                                        Hide
                                                    </option>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                <label class="form-label" for="text">Change Background *</label>
                                                <input type="file" class="form-control" name="testimonial_background"
                                                    id="photo3">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="v-pills-6" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label class="form-label " for="blog_heading">Blog Heading
                                                    *</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label class="form-label " for="blog_subheading">Blog Sub Heading
                                                </label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                <label class="form-label " for="blog_status">Status
                                                    *</label>
                                                <select name="blog_status" id="blog_status" class="form-control">
                                                    <option selected disabled> -- Choose --</option>
                                                    <option value="Show" {{ $page_home_data->blog_status ==
                                                        'Show' ? 'selected' : '' }}>
                                                        Show
                                                    </option>
                                                    <option value="Hide" {{ $page_home_data->blog_status ==
                                                        'Hide' ? 'selected' : '' }}>
                                                        Hide
                                                    </option>
                                                </select>
