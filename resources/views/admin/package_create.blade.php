                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" class="form-control @error('package_price') is-invalid @enderror"
                                        name="package_price" value="{{ old('package_price') }}">
                                    @error('package_price')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text"
                                        ...
                                        name="package_display_time" value="{{ old('package_display_time') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="number"
                                        ...
                                        name="total_allowed_jobs" value="{{ old('total_allowed_jobs') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        name="total_allowed_photos" value="{{ old('total_allowed_photos') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-1">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        name="total_allowed_videos" value="{{ old('total_allowed_videos') }}">
