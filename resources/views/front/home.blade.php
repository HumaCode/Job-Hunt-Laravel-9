...
<div class="slider" style="background-image: url('/storage/uploads/banner5.jpg')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <input type="text" name="" class="form-control" placeholder="Job Title" />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
...
<div class="why-choose" style="background-image: url('/storage/uploads/banner3.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
...
<div class="testimonial" style="background-image: url('/storage/uploads/banner11.jpg')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12">
                <div class="testimonial-carousel owl-carousel">
                    <div class="item">
                        <div class="photo">
                            <img src="{{ \Storage::url('uploads/t1.jpg') }}" alt="" />
                        </div>
                        <div class="text">
                            <h4>Robert Krol</h4>
                            <p>CEO, ABC Company</p>
                    ...
                    <div class="item">
                        <div class="photo">
                            <img src="{{ \Storage::url('uploads/t2.jpg') }}" alt="" />
                        </div>
                        <div class="text">
                            <h4>Sal Harvey</h4>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <div class="photo">
                        <img src="{{ \Storage::url('uploads/banner1.jpg') }}" alt="" />
                    </div>
                    <div class="text">
                        <h2>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <div class="photo">
                        <img src="{{ \Storage::url('uploads/banner2.jpg') }}" alt="" />
                    </div>
                    <div class="text">
                        <h2>
                            <a href="post.html">This is a sample blog post title</a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    <div class="photo">
                        <img src="{{ \Storage::url('uploads/banner3.jpg') }}" alt="" />
                    </div>
                    <div class="text">
                        <h2>
                            <a href="post.html">This is a sample blog post title</a>
